    ...
    <form class="form" action="loginn.php " method="post">
        ...
        <?php
            if (isset($_GET['error']) && $_GET['error'] == 1) {
                echo '<div class="alert alert-danger" role="alert">Invalid password or username. Please try again.</div>';
            }
        ?>
        <p class="p">Don't have an account? <span class="span"> <a href="../Register/Register.php">Register now</a></span></p>
        </div>
        <div class="flex-row">
